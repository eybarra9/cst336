<form>
    ...
    <!--Question 4-->
    What are the official colors of CSUMB?<br />
    <input type="radio" name="question4" id="q4-1"  value="A"/><label for='q4-1'>Navy Blue, Seaweed Green, Yellow<br />
    <input type="radio" name="question4" id="q4-2"  value="B"/><label for='q4-2'>Bay Blue, Valley Green, Golden Sand<br />
    <input type="radio" name="question4" id="q4-3"  Value="C"/><label for='q4-3'>Magenta, Burgundy, Pink<br />
